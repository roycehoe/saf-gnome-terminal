...
###########################################################################################################################
# Script coppied and modified from the following link: https://github.com/nordtheme/gnome-terminal/blob/develop/src/nord.sh
###########################################################################################################################
...
apply() {
  local \
    ...
    palette14="#2AA1B3" \
    palette15="#EDF2D0" \
    highlightForeground="rgb(35,36,31)"\
    highlightBackground="rgb(255,115,0)"\
    cursorForeground="rgb(56,57,49)"\
    cursorBackground="rgb(237, 242, 208)"\
    terminalText="rgb(237, 242, 208)"\
    terminalBackground="rgb(56, 57, 49)"\
  ...
  _write background-color "'$terminalBackground'"
  _write foreground-color "'$terminalText'"
  _write use-transparent-background "false"
  log 4 "Applied background- and foreground colors"

  _write bold-color "'$terminalText'"
  ...
  _write cursor-foreground-color "'$cursorForeground'"
  _write cursor-background-color "'$cursorBackground'"
  log 4 "Applied cursor colors and configuration"

  _write highlight-colors-set "true"
  _write highlight-foreground-color "'$highlightForeground'"
  _write highlight-background-color "'$highlightBackground'"
